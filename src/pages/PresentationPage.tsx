...
export const PresentationPage: React.FC = () => {
    ...
    return (
        <div className="h-full w-full xl:h-screen xl:w-screen flex items-center justify-center mt-20 lg:14 xl:mt-0">
            <div className="grid xl:grid-cols-3 sm:grid-cols-1 items-center">
                <div className="xl:col-span-2 sm:col-span-1 xl:mr-20 sm:mb-10 flex flex-col justify-center items-center xl:items-start w-auto">
                ...
                <div className='flex flex-col items-center col-span-1'>
                    <div className="w-72 2xl:w-80 rounded-xl overflow-hidden shadow-2xl">
